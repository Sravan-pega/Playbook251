...
function PegaFieldContextualAlert(props: PegaFieldContextualAlertProps) {
  ...
  const renderMessage = () => {
    ...
    return (
      <div className="alert-message text-content" style={{ color: config.textColor }}>
        {message}
      </div>
    );
  };
